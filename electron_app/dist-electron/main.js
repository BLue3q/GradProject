...
const cleanupResources = (tempFile, outputFile) => {
    try {
    ...
    try {
        ...
        return await new Promise((resolve) => {
            ...
            (0, child_process_1.exec)(compileCommand, (compileError, compileStdout, compileStderr) => {
                ...
                currentProcess = (0, child_process_1.spawn)(execPath, [], { stdio: ['pipe', 'pipe', 'pipe'] });
...
electron_1.ipcMain.on('send-program-input', (_, input) => {
